<?php 
	...
	if(isset($_GET['vacancy_id'])){
		...
		echo 'please apply from clicking apply now in vacancies';
		die();
	}
?>
<html>
<head>
	...
	<script type="text/javascript">
	    ...
	    var uploadAndDisplayPhoto = function(){};
	    var canvas;
	    var ctx;
	    var img;
		var fr;
		...
		$(document).ready(function(){
			...
			submitApplication = function(){
				...
				$('.array-row').each(function(){
					...
					input_variables[id] = temp_array; 
				});

				var radio_variables = {};
				$('input[type="radio"]:checked').each(function(){
					radio_variables[$(this).attr('name')] = $(this).val();
				});

				input_variables['radio'] = radio_variables;

				var variables = {};
				variables['vacancy_id'] = vacancy_id;
				variables['surname'] = $('#surname').val();
				variables['othername'] = $('#other-names').val();
				variables['app_data'] = input_variables;
				variables['photo'] = uploadImage;

				sendRequestToServer(url,'addApplicationsRecord', 'applications', variables, function(res){console.log(res)});
	    	}
		});
	</script>
<style type="text/css">
			...
			<tr>
				...
				<td style="vertical-align: middle; text-align: center">
					<table style="width:100pt; margin:0 10pt 0 10pt;">
						<tr>
							<td style="background-color: #C6D9F1; height: 134.64pt;width:106.56pt; text-align: center">
								Photo
